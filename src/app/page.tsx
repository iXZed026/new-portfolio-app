...
export default function Home() {
  ...
  return (
    <>
      ...
      {/* About Section */}
      <div id='about' data-section="about" className='min-h-[100vh]'>
        <AboutSection />
      </div>

      {/* Projects Section */}
      <div id='projects' data-section="projects" className='min-h-[100vh]'>
        <ProjectsSection />
      </div>

      {/* Contact Section */}
      <div id='contact' data-section="contact" className='min-h-[100vh]'>
        <ContactSection />
      </div>
    </>
  );
